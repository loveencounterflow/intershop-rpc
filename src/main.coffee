...
#-----------------------------------------------------------------------------------------------------------
@new_server = ( port ) -> new Promise ( resolve, reject ) =>
  R           = {}
  R.xemitter  = DATOM.new_xemitter()
  R.stop      = -> R.server.close()
  #.........................................................................................................
  R.server    = NET.createServer ( socket ) =>
    ...
    pipeline.push @$show_counts   R
    pipeline.push @$dispatch      R
    pipeline.push $drain()
    #.......................................................................................................
    SP.pull pipeline...
    return null
...
@$show_counts = ( me ) -> $watch ( event ) ->
  ...
  if me.show_counts and ( me.counts.requests % me.count_interval ) is 0
