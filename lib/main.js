(function() {
  'use strict';
  var $, $async, $drain, $watch, CND, DATOM, Multimix, NET, Rpc, SERVER, SP, _defaults, alert, badge, cast, debug, echo, freeze, help, info, isa, jr, new_datom, rpr, select, type_of, urge, validate, warn, whisper;
  ...
  Rpc = (function() {
    ...
    class Rpc extends Multimix {
      ...
      constructor(settings) {
        ...
        this.settings = freeze({..._defaults, ...settings});
